            ...
            <section id="registration" className="container" style={{ marginBottom: '18px' }}>
                <div className="center">
                    ...
                    <fieldset className="registration-form">
                        ...
                        <div className="form-group">
                            <input type="text" id="username" name="username" placeholder="NIM" className="form-control" required="" onChange={(e) => setNim(e.target.value)} />
                        </div>
                        <div className="form-group">
                            <input type="password" id="password" name="password" placeholder="Password" className="form-control" required="" onChange={(e) => setPassword(e.target.value)} />
                        </div>
                        <div className="form-group">
                            <button onClick={() => handleLogin()} className="btn btn-success btn-md btn-block">Login</button>
                        </div>
                    </fieldset>
                </div>
            </section>
